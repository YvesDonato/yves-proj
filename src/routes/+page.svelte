...
<div class="md:grid md:grid-cols-2 gap-6 overflow-auto md:h-96 text-gray-300 rounded-lg shadow-xl my-12 lg:mx-32 p-10 bg-gray-800">
  ...
  <div class="my-auto">
    ...
    <form method="POST" class="flex flex-col xl:mx-2 xl:flex-row xl:justify-center xl:space-y-0">
      <input id="email" type="email" name="email" class="px-6 py-3 bg-white border rounded-md bg-gray-900 text-gray-300 border-gray-600 focus:ring-blue-300 focus:ring-opacity-40 focus:border-blue-300 focus:outline-none focus:ring sm:mx-2" placeholder="Email Address" required/>
