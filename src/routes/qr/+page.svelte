<div class="animate-slide-in flex flex-col md:gap-6 gap-2 pb-1 pt-6">
  <!-- Profile Card -->
  ...
  <div class="rounded-lg bg-gray-800 p-6 text-gray-300 shadow">
    <div class="flex items-center justify-between mb-4">
      <h2 class="text-xl font-semibold text-white">Featured Project</h2>
      <span class="rounded-full bg-gradient-to-r from-red-400 to-blue-500 px-3 py-1 text-xs font-medium text-white">2x Winner</span>
    </div>
    <h3 class="text-lg font-semibold text-white mb-1">NeuRizz</h3>
    <p class="text-sm text-gray-500 mb-2">2x Category Winner @ Hackville · Jan 2026</p>
    <p class="text-gray-400 mb-4">
      AI-powered date preparation and mentorship platform for neurodivergent users. Features real-time 
      conversation coaching, voice synthesis for text tone analysis, and social skill simulations.
    </p>
    <div class="flex flex-wrap gap-2 mb-4">
      <span class="rounded-full bg-gray-700 px-3 py-1 text-xs text-gray-300">SvelteKit</span>
      <span class="rounded-full bg-gray-700 px-3 py-1 text-xs text-gray-300">Tailwind</span>
    ...
    <div class="flex gap-3 flex-wrap">
      ...
      <!-- <a href="/projects" class="inline-flex items-center rounded-lg border border-gray-600 bg-gray-800 px-4 py-2 text-sm font-medium text-gray-400 hover:bg-gray-700 hover:text-white"> -->
      <!--   View All Projects -->
      <!--   <svg class="ms-2 h-3 w-3 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"> -->
  ...
  <div class="rounded-lg bg-gray-800 p-4 text-center text-gray-300 shadow">
    <p class="text-sm text-gray-500">
      <span class="inline-flex items-center">
        ...
        Scanned from QR · <a href="/" class="ml-1 text-blue-500 hover:underline">yvesdonato.com</a>
      </span>
    </p>
  </div>
</div>
